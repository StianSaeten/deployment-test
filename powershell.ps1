$githubOrganizationName = 'stiansaeten'
$githubRepositoryName = 'deployment-test'
...
$productionResourceGroup = New-AzResourceGroup -Name ToyWebsiteProduction -Location westeurope
